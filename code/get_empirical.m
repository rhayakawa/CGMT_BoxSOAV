function [MSE,SER]=get_empirical(N,Delta,arrP,arrR,arrQ,arrThr,SNR,nIteration,nSample)
  % get_empirical: get empirical performance of Box-SOAV optimization
  %
  % Input
  ...
  for sampleIndex=1:nSample
    ...
    for k=2:nIteration
      ...
      z_til=z_til+theta*(softThr(2*z-z_til,gamma,arrQ,arrR)-z);
    end
